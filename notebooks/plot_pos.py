...
'''
Plot for one model (diff POS sets)
'''
...
if setting == 1:
    tag_list = ["FREQ", "INFREQ", "RAND", "VERB", "PROPN", "NOUN", "PUNCT", "ADP", "ADJ", "ADV", "DET", "NUM", "PUNCT",
                "PRON"]
    plot_tag = "all"
elif setting == 2:
...
models = ["xlm-mlm-en-2048", "bert-base-cased", "roberta-base", "xlnet-base-cased"]
for model_name in models:
    ...
    # plt.show()
    plot_path = "../../plots/"
    plt.savefig(plot_path + f'z_{dataset}_{measure}_{start}_{end}_{plot_tag}_{model_name.split("-")[0].lower()}.pdf',
                bbox_inches='tight')
